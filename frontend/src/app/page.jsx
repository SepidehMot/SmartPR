  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <p className="text-secondary-600 mb-6">
        ...
        then occupied when you arrive, and returns to free when you leave or it
        expires.
      </p>
      ...
      <div className="border border-secondary-200 rounded-md p-4">
        ...
        <ol className="list-decimal pl-5 space-y-1 text-secondary-700 mt-4">
          ...
          <li>
            Enter your plate number and choose a duration (and optionally a
            start time).
          </li>
          <li>Confirm reservation. The lock reserves the slot.</li>
